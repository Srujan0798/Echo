...
const MatchModal: React.FC<MatchModalProps> = ({ isOpen, currentUser, matchedProfile, onClose, onInitiateConnection }) => {
  if (!isOpen || !matchedProfile || !currentUser) return null;

  return (
    <div className="fixed inset-0 bg-black/80 z-50 flex flex-col items-center justify-center p-4 animate-fadeIn backdrop-blur-sm">
      ...
      <div className="relative flex items-center justify-center mb-10 animate-scaleIn" style={{ animationDelay: '100ms' }}>
      ...
      <div className="w-full max-w-xs space-y-3 animate-scaleIn" style={{ animationDelay: '200ms' }}>
        <Button onClick={onInitiateConnection}>Start the Conversation</Button>
